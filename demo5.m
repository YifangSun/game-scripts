...
% show_range = [left_angle-angle_space+2.5, left_angle-2.5];
% test = imrotate(data_2,10*15,'nearest','crop');
% imshow(test);
% hold on;
% x = 1:420;
% y1 = 420 - (420-x)*abs(tan(show_range(1)/180*pi));
% y2 = 420 - (420-x)*abs(tan(show_range(2)/180*pi));
% plot(x,y1,'.');
% plot(x,y2,'.');
